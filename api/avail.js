// Vercel Function: proxy SmartOrder avail API
// GET /api/avail?checkIn=2026-07-01&checkOut=2026-07-03&adultCount=2
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const params = new URLSearchParams({ checkIn, checkOut, roomTypeId: ROOM_TYPE_ID, adultCount });
    const r = await fetch(`${BASE_URL}/booking/api/v3/avail/${HOTEL_ID}?${params}`, {
